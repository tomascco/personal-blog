...
> Note que não é uma boa prática implementar *getters* e *setters* na mão, pois além de já existirem os métodos _[attr](https://ruby-doc.org/core-2.7.2/Module.html#method-i-attr_accessor)_ para não poluir seu código com linhas quase idêncitas, escrever na marra é [menos performático](https://github.com/JuanitoFatas/fast-ruby#attr_accessor-vs-getter-and-setter-code).
